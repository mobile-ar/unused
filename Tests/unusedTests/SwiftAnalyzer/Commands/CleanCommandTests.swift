...
struct CleanCommandTests {
    ...
    @Test func testCleanRemovesMultipleUnusedFiles() async throws {
        ...
        let unusedFile1 = tempDir.appendingPathComponent(".unused")
        let subDir = tempDir.appendingPathComponent("subdir")
        try FileManager.default.createDirectory(at: subDir, withIntermediateDirectories: true)
        let unusedFile2 = subDir.appendingPathComponent(".unused")
    ...
    @Test func testCleanRecursivelySearchesSubfolders() async throws {
        ...
        let unusedFile1 = tempDir.appendingPathComponent(".unused")
        let unusedFile2 = level1.appendingPathComponent(".unused")
        let unusedFile3 = level2.appendingPathComponent(".unused")
        let unusedFile4 = level3.appendingPathComponent(".unused")
    ...
    @Test func testCleanIgnoresBuildDirectory() async throws {
        ...
        let unusedFileInRoot = tempDir.appendingPathComponent(".unused")
        let unusedFileInBuild = buildDir.appendingPathComponent(".unused")
