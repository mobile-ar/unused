...
struct CSVWriter {
    ...
    private static func parseCSVLine(_ line: String) -> (Int, Declaration)? {
        ...
        let type: DeclarationType = switch typeString {
        ...
        let reason: ExclusionReason = switch reasonString {
        case "override": .override
        case "protocol": .protocolImplementation
        case "objc": .objcAttribute
